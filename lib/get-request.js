...
exports.getRequest = function getRequest(options, callback) {
  ...
  var params = _.extend({}, getDefaultParams(options), options.params);
  ...
  debug('GET request options', reqOptions);
