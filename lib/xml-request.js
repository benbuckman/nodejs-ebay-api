...
function extractErrorCodes(errorJson) {
  try {
...
exports.xmlRequest = function(options, callback) {
  ...
  request.post(options.reqOptions, function(error, response) {
    ...
    function _done(error, data) {
      ...
      var extraErrorProps = {};
      var nonCriticalErrors = {
        "21917182": true, //for getOrders. Will show up if user has had an order removed for violation

      };
      var errorCodes = extractErrorCodes(error);
      if (errorCodes !== null){
