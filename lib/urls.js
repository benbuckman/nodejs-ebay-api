...
exports.buildRequestUrl = function(options) {
  ...
  switch (serviceName) {
    ...
    case 'BulkDataExchange':
      if (options.sandbox) url = 'https://webservices.sandbox.ebay.com/BulkDataExchangeService';
      else url = "https://webservices.ebay.com/BulkDataExchangeService";
      break;

    case 'FileTransfer':
      if (options.sandbox) url = 'https://storage.sandbox.ebay.com/FileTransferService';
      else url = "https://storage.ebay.com/FileTransferService";
      break;
